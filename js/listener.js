...
function chargingChangeListener() {
    ...
    //sendNotification("Battery charge", "Battery charge: " + battery.charging);
    //BatteryAutoSet();
}
...
function levelChangeListener() {
    ...
    //var batteryLevelPercent = battery.level * 100;
    //alert("Battery charge: " + batteryLevelPercent + "\%");
    //sendNotification("Battery level", "Battery level: " + batteryLevelPercent + "\%");
    //BatteryAutoSet();
}
